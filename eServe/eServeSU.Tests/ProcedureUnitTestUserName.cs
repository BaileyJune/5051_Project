...
namespace eServeUnitTest
{
    ...
    public class ProcedureUnitTestUsername
    {
        ...
        public int role()
        {
            ...
            var reader = dbHelper.VerifyUser(Constant.sp_VerifyUser, "nouser@yahoo.com", "Janedoe!1");
            int num = 0;
            while (reader.Read())
            {
