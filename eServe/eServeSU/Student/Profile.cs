...
namespace eServeSU
{
    public class Profile
    {
        ...
        public void UpdateStudentProfile(int studentId, string preferedName, string gender, string isInternationalStudent)
        {
            dbHelper.UpdateStudentProfile(Constant.SP_UpdateStudentProfile, studentId, preferedName, gender, isInternationalStudent);
        }
