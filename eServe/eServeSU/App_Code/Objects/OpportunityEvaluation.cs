...
namespace eServeSU
{
    public class OpportunityEvaluation
    {
        ...
        public void GetStudentEvaluation(int OpportunityID, int StudentID)
        {

            var reader = dbHelper.GetStudentEvaluation(Constant.SP_GetStudentEvaluation, this.OpportunityID, this.StudentID);
            while (reader.Read())
            {
               // OpportunityEvaluation Eval = new OpportunityEvaluation();
