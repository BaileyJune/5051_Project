...
namespace eServeSU
{
    public class CommunityPartnersProfile
    {
        public CommunityPartnersProfile()
        {
            //
        ...
        public void GetcommunityPartnerProfile(int cpid)
        {
            var reader = dbHelper.GetcommunityPartner(Constant.SP_GetCommunityPartnerProfile, cpid);
        ...
        public void UpdateCommunityPartnerProfile()
        {
            dbHelper.UpdateCommunityPartnerProfile(Constant.SP_UpdateCommunityPartnerProfile, this.CPID, this.OrganizationName,
                this.Address, this.Website, this.MainPhone, this.MissionStatement, this.WorkDescription);
        }
